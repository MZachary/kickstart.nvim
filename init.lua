...
require('lazy').setup(
  {
    ...
    },
    {
      'mfussenegger/nvim-dap-python',
      config = function()
        require("dap-python").setup("/home/m333839/python_venvs/global/3.12.5/bin/python")
        end
    },
    {
...
vim.o.conceallevel = 1 --for obsidian
...
-- I can't imagine open_note stuff is really the best way to do this, but i couldnt figure
-- out how to do it correctly. just calling obsidian:today() would make the note but not
-- actually open it
...
vim.keymap.set('n', '<leader>oy', function()
  obsidian:open_note(obsidian:yesterday().path:resolve())
end, { desc = 'Obsidian Yesterday' })
vim.keymap.set('n', '<leader>ot', function()
  obsidian:open_note(obsidian:tomorrow().path:resolve())
...
vim.keymap.set('n', '<leader>on', function()
  ...
  obsidian:open_note(obsidian:create_note({title=title}).path:resolve())
end, { desc = 'Obsidian Open Note' })
vim.keymap.set('n', '<leader>oqs', function()
  -- obsidian:command("QuickSwitch")
  require('obsidian').util.quick_switch()
